  ...
  return (
    <div className="min-h-screen flex bg-neutral-50">
      ...
      <div className="hidden lg:flex lg:w-[52%] xl:w-[55%] sticky top-0 h-screen flex-col justify-between p-10 xl:p-14 bg-linear-to-br from-zinc-900 via-zinc-800 to-zinc-600 overflow-hidden">
        ...
        <Globe     className="absolute top-[63%] left-[35%] w-4 h-4 text-zinc-200/20 animate-eco-float pointer-events-none" style={{ animationDelay: "2.5s" }} />
        <Leaf      className="absolute bottom-20 right-1/4 w-3 h-3 text-zinc-300/20 animate-eco-float pointer-events-none" style={{ animationDelay: "3s" }} />
        ...
        <div className="relative z-10 animate-eco-fade-down">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <span className="text-xs text-zinc-200/70 mt-0.5 block">Sustainable Future Initiative</span>
            </div>
          </div>
        </div>
        ...
        <div className="relative z-10 space-y-8 animate-eco-fade-up animate-delay-200">
          <div>
            <div className="flex items-center gap-2 mb-5">
              ...
              <span className="text-zinc-200/75 text-xs font-medium tracking-widest uppercase">Start Your Journey</span>
            </div>
        ...
        <div className="relative z-10 animate-eco-fade-in animate-delay-400">
          ...
          <p className="mt-2 text-zinc-200/30 text-[11px]">© 2026 EcoSpark Hub. All rights reserved.</p>
        </div>
      </div>
        ...
        <div className="w-full max-w-105">
            ...
            <div className="px-6 py-7 sm:px-8">
              ...
              >
                ...
                <p className="text-center text-sm text-muted-foreground pt-1">
                  ...
                  <Link href="/login" className="text-zinc-600 font-semibold hover:underline underline-offset-4 transition-colors">
                    Sign in
                  </Link>
                </p>
              </form>
          ...
          <div className="mt-5 text-center space-y-2 animate-eco-fade-in animate-delay-500">
            ...
            <p className="text-xs text-muted-foreground">
              ...
              <Link href="/terms" className="text-zinc-600 hover:underline underline-offset-2">Terms of Service</Link>
              {" "}and{" "}
